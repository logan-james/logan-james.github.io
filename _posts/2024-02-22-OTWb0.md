...
This command initiates an *SSH* connection to [bandit.labs.overthewire.org](https://overthewire.org/wargames/bandit/) on port 2220, logging in as the user ``bandit0``.
